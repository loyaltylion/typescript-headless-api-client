    ...
    schemas: {
        ...
        SiteConfiguration: {
            ...
            tier_configuration: {
                ...
                tiers: (components["schemas"]["PointsTier"] | components["schemas"]["SpendTier"] | components["schemas"]["OrdersTier"] | components["schemas"]["ConditionalTier"])[];
                tier_benefits: {
                    id: number;
                    /**
        ...
        CustomerEnrolled: {
            ...
            tier_membership: {
                ...
                progress: components["schemas"]["TierProgressPoints"] | components["schemas"]["TierProgressSpend"] | components["schemas"]["TierProgressOrders"];
            } | null;
            /**
         ...
         *         },
         *         "receipt_upload_url": "https://upload.loyaltylion.com/_/_",
         *         "referral_urls": {
        ...
        CompleteRuleErrorRuleRequirementsNotMet: {
            /**
             * @description discriminator enum property added by openapi-typescript
             * @enum {string}
             */
    ...
    "rules.completeClickthrough": {
        ...
        responses: {
            ...
            422: {
                ...
                content: {
                    "application/json": {
                        error: components["schemas"]["CompleteRuleErrorCustomerNotEnrolled"] | components["schemas"]["CompleteRuleErrorCustomerBlocked"] | components["schemas"]["CompleteRuleErrorRuleNotEnabledForCustomer"] | components["schemas"]["CompleteRuleErrorRuleInvalidKind"] | components["schemas"]["CompleteRuleErrorRuleLimitReached"] | components["schemas"]["CompleteRuleErrorRuleRequirementsNotMet"];
                    };
                };
            };
            /** @description 429 */
